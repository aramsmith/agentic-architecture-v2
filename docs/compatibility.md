...
| macOS | Node.js 22+ and equivalent shell commands | CI configured for Node 22/24 on macOS, Windows and Linux | Confirm successful matrix runs on the release commit; configuration alone is not verification. |
